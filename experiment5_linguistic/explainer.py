    ...
    while retries < 5:
        async with session.post("https://api.openai.com/v1/chat/completions", json=data, headers=headers) as response:
            ...
            if 'choices' in result and result['choices']:
                ...
                if latest_message.count('. ') >= 2 and '%' not in latest_message:
